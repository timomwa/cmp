...
insert into `pixeland_content360`.`profile_configs`(id,data_type,`effectiveDate`,`name`,`value`,`profile_id_fk`) values(128080246,'string', now(),'http_sms_msg_param_name','sms',89016857);
insert into `pixeland_content360`.`profile_configs`(id,data_type,`effectiveDate`,`name`,`value`,`profile_id_fk`) values(128080247,'string', now(),'http_useheader','no',89016857);
insert into `pixeland_content360`.`profile_configs`(id,data_type,`effectiveDate`,`name`,`value`,`profile_id_fk`) values(128080248,'string', now(),'http_haspayload','yes',89016857);
insert into `pixeland_content360`.`profile_configs`(id,data_type,`effectiveDate`,`name`,`value`,`profile_id_fk`) values(128080249,'string', now(),'http_is_restful','no',89016857);
insert into `pixeland_content360`.`profile_configs`(id,data_type,`effectiveDate`,`name`,`value`,`profile_id_fk`) values(128080250,'string', now(),'http_header_auth_hasmultiple_kv_pairs','no',89016857);
insert into `pixeland_content360`.`profile_configs`(id,data_type,`effectiveDate`,`name`,`value`,`profile_id_fk`) values(128080251,'string', now(),'http_allow_send_blank_text','no',89016857);
insert into `pixeland_content360`.`profile_configs`(id,data_type,`effectiveDate`,`name`,`value`,`profile_id_fk`) values(128080252,'string', now(),'http_payload_template_name','parlayx_template',89016857);
insert into `pixeland_content360`.`profile_configs`(id,data_type,`effectiveDate`,`name`,`value`,`profile_id_fk`) values(128080254,'string', now(),'http_payload_param_spId','36',89016857);
insert into `pixeland_content360`.`profile_configs`(id,data_type,`effectiveDate`,`name`,`value`,`profile_id_fk`) values(128080255,'string', now(),'http_payload_param_spPassword','96e79218965eb72c92a549dd5a330112',89016857);
insert into `pixeland_content360`.`profile_configs`(id,data_type,`effectiveDate`,`name`,`value`,`profile_id_fk`) values(128080256,'string', now(),'http_payload_param_interfaceName','interfaceName',89016857);
insert into `pixeland_content360`.`profile_configs`(id,data_type,`effectiveDate`,`name`,`value`,`profile_id_fk`) values(128080257,'string', now(),'http_transaction_id_param_name','txid',89016857);
