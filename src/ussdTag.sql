INSERT INTO `cmp`.`smsmenu_levels` (`name`, `language_id`, `parent_level_id`, `menu_id`, `serviceid`, `visible`, `ussdTag`) VALUES ('1. 5/- per Day', '1', '151', '2', '439', '1', '*50');
INSERT INTO `cmp`.`smsmenu_levels` (`name`, `language_id`, `parent_level_id`, `menu_id`, `serviceid`, `visible`, `ussdTag`) VALUES ('2. 15/- per Day', '1', '151', '2', '440', '1', '*51');
INSERT INTO `cmp`.`smsmenu_levels` (`name`, `language_id`, `parent_level_id`, `menu_id`, `serviceid`, `visible`, `ussdTag`) VALUES ('3. 30/- per Month', '1', '151', '2', '441', '1', '*52');
INSERT INTO `cmp`.`smsmenu_levels` (`name`, `language_id`, `parent_level_id`, `menu_id`, `serviceid`, `visible`, `ussdTag`) VALUES ('Subscription Options', '1', '-1', '2', '-1', '1', '*100');


UPDATE `cmp`.`smsmenu_levels` SET `name`='Purchase Chat bundles' WHERE `id`='151';
INSERT INTO `cmp`.`smsmenu_levels` (`name`, `language_id`, `parent_level_id`, `menu_id`, `serviceid`, `visible`, `ussdTag`) VALUES ('Find friend near you', '1', '-1', '2', '-1', '1', '*200');
UPDATE `cmp`.`smsmenu_levels` SET `name`='5/- per Day' WHERE `id`='148';
UPDATE `cmp`.`smsmenu_levels` SET `name`='15/- per Day' WHERE `id`='149';
UPDATE `cmp`.`smsmenu_levels` SET `name`='30/- per Month' WHERE `id`='150';


INSERT INTO `cmp`.`sms_service` (`mo_processorFK`, `cmd`, `push_unique`, `price`, `price_point_keyword`, `CMP_Keyword`, `CMP_SKeyword`, `enabled`, `split_mt`, `subscription_length`, `subscription_length_time_unit`) VALUES ('14', 'FIND', '1', '0', 'MAPENZI', 'IOD', 'IOD0000', '1', '0', '1', 'DAY');
INSERT INTO `cmp`.`sms_service` (`mo_processorFK`, `cmd`, `push_unique`, `price`, `price_point_keyword`, `CMP_Keyword`, `CMP_SKeyword`, `subscription_length`, `subscription_length_time_unit`) VALUES ('14', 'TAFUTA', '1', '0', 'MAPENZI', 'IOD', 'IOD0000', '1', 'DAY');


UPDATE `cmp`.`smsmenu_levels` SET `serviceid`='442' WHERE `id`='152';
...
UPDATE `cmp`.`message` SET `message`='Sorry <USERNAME>. Please top up & renew your <SERVICE_NAME> subscription to continue chatting with <DEST_USERNAME>. Dial *329# to subscribe to chat bundles.' WHERE `id`='41';
UPDATE `cmp`.`message` SET `message`='Sorry <USERNAME>. Please top up & renew your <SERVICE_NAME> subscription to continue chatting with <DEST_USERNAME>. Dial *329# to subscribe to chat bundles.' WHERE `id`='42';
UPDATE `cmp`.`message` SET `message`='Sorry, Please renew your subscription to continue enjoying enjoying the service. Dial *329# to purchase chat bundle.' WHERE `id`='37';
UPDATE `cmp`.`message` SET `message`='Sorry, Please renew your subscription to continue enjoying enjoying the service. Dial *329# to purchase chat bundle.' WHERE `id`='38';
...
INSERT INTO `cmp`.`sms_service` (`mo_processorFK`, `cmd`, `push_unique`, `service_name`, `service_description`, `price`, `price_point_keyword`, `CMP_Keyword`, `CMP_SKeyword`, `enabled`, `split_mt`) VALUES (14, 'BUNDLES', 1, 'Chat bundles', 'Chat bundles', 0, '32329_MAPENZI', 'IOD', 'IOD0000', 1, 0);
INSERT INTO `cmp`.`sms_service_metadata` (`sms_service_id_fk`, `meta_field`, `meta_value`) VALUES (444, 'db_name', 'cmp');
UPDATE `cmp`.`smsmenu_levels` SET `serviceid`=444 WHERE `id`='151';
UPDATE `cmp`.`smsmenu_levels` SET `serviceid`=-1 WHERE `id`='151';
UPDATE `cmp`.`smsmenu_levels` SET `serviceid`=444 WHERE `id`='151';
...
BEGIN
    select * from cmp.subscription s where s.subscription_status='confirmed' AND s.msisdn=msisdn_;
END;
$
DELIMITER ;
