package com.inmobia.axiata.web.triviaI;
...
public interface MechanicsI {
	 ...
	 * 
	 * @param questionId
	 * @return enum - com.inmobia.axiata.web.beans.Answer - answer of the question
	 */
	 ...
	 * @param questionId
	 * @return com.inmobia.axiata.web.beans.Question - the question object
	 */
	 ...
	 * @param sub
	 * @return com.inmobia.axiata.web.beans.Question - the question
	 */
	...
	/**
	 * 
	 * @param key com.inmobia.axiata.web.beans.MessageType - can be either;<br/>
	 * 
	 ...
	 * @throws com.inmobia.axiata.exceptions.MessageNotSetException  - this is thown when the message is not set in the db.
	 */
	 ...
	 * @throws com.inmobia.axiata.exceptions.NoSettingException  - this is thrown when the setting is not set in the db
	 */
	 ...
	 * @param sub - com.inmobia.axiata.web.beans.Subscriber
	 ...
	 * @return com.inmobia.axiata.web.beans.Subscriber - the subscriber if he exists, else null is returned
	 */
