...
public class SMPPTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try{
			...
			opcoconfigs.put(Sender.SMPP_IP, ProfileConfigs.createBasic(Sender.SMPP_IP, "127.0.0.1") );
			opcoconfigs.put(Sender.SMPP_PORT, ProfileConfigs.createBasic(Sender.SMPP_PORT, "2775") );
			opcoconfigs.put(Sender.SMPP_TYPE, ProfileConfigs.createBasic(Sender.SMPP_TYPE, "smpp") );
			opcoconfigs.put(Sender.SMPP_USERNAME, ProfileConfigs.createBasic(Sender.SMPP_USERNAME, "smppclient1") );
			opcoconfigs.put(Sender.SMPP_PASSWORD, ProfileConfigs.createBasic(Sender.SMPP_PASSWORD, "password") );
			opcoconfigs.put(Sender.SMPP_TON, ProfileConfigs.createBasic(Sender.SMPP_TON, "1") );
			opcoconfigs.put(Sender.SMPP_NPI, ProfileConfigs.createBasic(Sender.SMPP_NPI, "1") );
