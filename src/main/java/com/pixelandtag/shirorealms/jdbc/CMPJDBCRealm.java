package com.pixelandtag.shirorealms.jdbc;
...
public class CMPJDBCRealm extends JdbcRealm {
	
	    
	    protected static final String DEFAULT_AUTHENTICATION_QUERY = "select password from user where username = ?";  
	  
	    /** 
	     * The default query used to retrieve the roles that apply to a user. 
	     */  
	    protected static final String DEFAULT_USER_ROLES_QUERY =   
	            "select rl.name from user_role r left join user u on u.id = r.user_id left join role rl on rl.id=r.roles_id where u.username = ?";  
	    ...
	    private static final Logger log = LoggerFactory.getLogger(CMPJDBCRealm.class);  
