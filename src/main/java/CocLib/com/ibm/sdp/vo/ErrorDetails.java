...
public class ErrorDetails  implements java.io.Serializable {
    ...
    /**
     * Gets the errorMessage value for this ErrorDetails.
     * 
     * @return errorMessage
     */
    ...
    /**
     * Sets the errorMessage value for this ErrorDetails.
     * 
     * @param errorMessage
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://CocLib/com/ibm/sdp/vo", "ErrorDetails"));
