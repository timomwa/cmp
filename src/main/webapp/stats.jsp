...
<!--  div id="menu"><a href="#" name="stats"
	onclick="GIANT.navigate(this)">Statistics</a><a href="#" name="account" onclick="GIANT.navigate(this)">My
...
<table width="100%" border="0">
	<tr>
		...
		<td>
			...
			<input id="phone_voucher_num" name="phone_voucher_num" type="text" value="Choose a Date" />
		...
		<td width="30%">
			...
			<button type="submit" class="search_btn" value="Search" ><img src="images/excel.png" />&nbsp;Dowload</button>
		
		</td>
		
		<td width="30%">
		
			<a href="#" onclick="GIANT.viewStats()" ><img src="images/sms_stat.png" alt="VIEW_STATS" />&nbsp;View Stats</a>
